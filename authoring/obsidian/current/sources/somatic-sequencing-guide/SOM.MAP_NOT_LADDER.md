...
generated: true
source_id: SOM.MAP_NOT_LADDER
guide_id: somatic-sequencing-guide
heading: This is a Map, But You Are the Explorer
...
But the evidence does not establish one universal sequence in which everyone must complete
```
