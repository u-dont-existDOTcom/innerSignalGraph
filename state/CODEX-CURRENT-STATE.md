...
Establish the applicable Codex + GitHub baseline for this private, active, critical-risk software repository without changing therapy/hypnosis policy, model roles, privacy scope, owner decisions, transactional installation, or `stable` release authority.
