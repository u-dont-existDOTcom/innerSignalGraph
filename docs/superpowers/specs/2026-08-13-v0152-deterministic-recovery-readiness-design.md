...
Scope: launcher recovery verification and test-environment isolation only; no therapy, hypnosis, guide, model-role, privacy, update-transaction, or owner-gate behavior changes
...
- No therapy, hypnosis, guide graph, Guide Packet, model entitlement, or owner-decision changes.
