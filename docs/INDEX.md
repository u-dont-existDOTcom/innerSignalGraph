...
- `CLAUDE-CONNECTOR.md`: InnerSignal in Claude as one MCP connector; the therapy protocol served from the deployed build, how map fixes go live, and one-time Claude OAuth setup
