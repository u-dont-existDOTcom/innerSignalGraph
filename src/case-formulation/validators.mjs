import { validatePathUpdate, validateRepresentationSelection, validateStrategyReview } from "./path-performance.mjs";
...
export function validateCaseAudit(value) {
  ...
  if (Object.hasOwn(value, "corrected_strategy_review")) value.corrected_strategy_review = validateStrategyReview(value.corrected_strategy_review);
  if (value.invalidate_strategy_review != null && typeof value.invalidate_strategy_review !== "boolean") throw new ValidationError("invalidate_strategy_review must be boolean.");
