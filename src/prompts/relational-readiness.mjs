...
- If no correction is needed, corrected_relational_readiness may be omitted. If current evidence no longer supports the field, invalidate it rather than preserving a stale person-level ban or clearance.
