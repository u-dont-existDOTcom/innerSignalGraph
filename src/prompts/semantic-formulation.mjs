...
export function boundedGraphAuditPrompt({ context, semanticFormulation, rawCaseExtraction, caseAuditDelta, auditedSnapshot, plan, authority }) {
  return {
