...
- Explicit suicide or harm evidence is decisive outer evidence: preserve O1 practical-safety priority and add the most direct unresolved risk question. A safety question without explicit suicide or harm evidence still comes first when material, but does not by itself convert a medical O3 route to O1.
- A consequential bodily, dependent, financial, or legal decision is O9 high-impact decision work even when capacity, lawful authority, or other decision details remain unknown. Do not let conservative unknowns erase the consequential decision already stated.
- An explicit professional support need with an unresolved access or continuity gap is O10 external handoff work; preserve the unmet need and actual handoff state.
