...
- Explicit suicide or harm evidence is decisive O1 outer evidence when the harm is acute bodily, dependent, or medical danger: preserve practical-safety priority and add the most direct unresolved risk question. Recurrent violent loss of control that includes throwing objects or destroying property requires O1 current-harm-risk and recurrence controls when the person reports that thinking or stopping is unavailable once an episode begins; remorse or insight does not establish behavioral control. Non-bodily privacy, recording, evidence-handling, or other rights containment remains O3 current-reality work when there is no acute physical, dependent, or medical safety unknown, even if urgent external action is required. A direct personal-safety question prompted by combined hopelessness or end-of-rope language may still come first without treating that indirect language as explicit suicide evidence or converting an otherwise valid O3 route to O1.
- A consequential bodily, dependent, financial, or legal decision is O9 high-impact decision work even when capacity, lawful authority, the exact option, timing, or other decision details remain unknown. Retrospective review of a completed high-impact bodily decision remains O9 when the current request separates decision authority, another person's grief or beliefs, privacy or disclosure, coercion, consequences, and each person's conduct; completion does not demote that authority review to generic O0 or O3. Stated financial dependence or possible basic-needs exposure keeps the decision consequential even when the precise action is not yet named. Do not let conservative unknowns erase the consequential decision already stated.
