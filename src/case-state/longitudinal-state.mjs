...
export function mergeRuntimeSnapshotIntoCaseState(previous, snapshot, { turnId, recordedAt = new Date().toISOString(), interventionContract = null } = {}) {
  ...
  return applyCaseStatePatch(projectEvidenceAuthority(previous), { items, intervention_history: interventionHistory, current_episode: currentEpisode, threat_pathway: threatPathway });
}
